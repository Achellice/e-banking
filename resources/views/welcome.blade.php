        ...
        document.body.appendChild(css);
                ...
                <div class="carousel-inner">
                  <div class="item active">
                    ...
                    <div class="carousel-caption">
                      <h1 style="font-weight:bolder; color:black;" class="text-center">Welcome To E-banking</h1>
          ...
          " class="banner bgcoloring">
            <h1 class="text-center" style="padding-top:17%;">
                <a style="text-shadow: 2px 2px; color:#fff; text-decoration: none;" href="" class="typewrite" data-period="2000" data-type='[ "Welcome To E-Banking.", "Your Banking Is Best Served Secure.", "Send And Recieve Money Easier And Faster.", "Save And Keep Track Of Your Transactions." ]'>
